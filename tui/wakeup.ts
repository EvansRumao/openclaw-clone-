...
export async function wakeup(){
  ...
  if(isCancel(options)){ //what this function does is to check if the user has cancelled the selection process, if they have it will print a message and exit the program
